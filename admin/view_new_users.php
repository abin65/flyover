        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-8 ftco-animate text-center">
                    <h1 class="mb-4">New Users List</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    ...
                    $query = "SELECT r.*, l.status FROM user_registration r JOIN login l ON r.login_id = l.login_id WHERE l.status ='0'";
                    $result = mysqli_query($con, $query);

                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            // Assuming 'photo_url' contains the path to the user's photo
                            ...
                            echo "<td><a href='approve_user.php?id=" . $row['login_id'] . "' class='btn btn-success'>Approve</a></td>";
                            // Reject button with href
                            echo "<td><a href='reject_user.php?id=" . $row['login_id'] . "' class='btn btn-danger'>Reject</a></td>";
                            echo "</tr>";
                        }
                    } else {
