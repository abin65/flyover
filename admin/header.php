        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="courses-link" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Users</a>
              <div class="dropdown-menu" aria-labelledby="courses-link">
                <a class="dropdown-item" href="view_new_users.php">New Users</a>
                <a class="dropdown-item" href="approved_users_list.php">Approved Users</a>
              </div>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="courses-link">
                <a class="dropdown-item" href="view_new_institutes.php">New Institute</a>
                <a class="dropdown-item" href="approved_institutes_list.php">Approved Institute</a>
              </div>
            </li>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="courses-link" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Institute Details</a>
              <div class="dropdown-menu" aria-labelledby="courses-link">
                <a class="dropdown-item" href="view_course_list.php">Courses list</a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="courses-link" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Application Report</a>
              <div class="dropdown-menu" aria-labelledby="courses-link">
                <a class="dropdown-item" href="course_report.php">Course Application</a>
                <a class="dropdown-item" href="job_report.php">Job Application</a>
                <a class="dropdown-item" href="internship_report.php">Internship Application</a>
                <a class="dropdown-item" href="program_report.php">Program Application</a>
              </div>
            </li>
            <li class="nav-item"><a href="view_faculty.php" class="nav-link" id="teacher-link">Facultys</a></li>
