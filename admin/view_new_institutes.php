        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-8 ftco-animate text-center">
                    <h1 class="mb-4">New Institutes List</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    ...
                    $query = "SELECT r.*, l.status FROM institute_reg r JOIN login l ON r.login_id = l.login_id WHERE l.status ='0'";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><button class='btn btn-info view-certificates' data-id='" . $row['institute_reg_id'] . "'>View Documents</button></td>";
                            // Approve button with href
                            echo "<td><a href='approve_institute.php?id=" . $row['login_id'] . "' class='btn btn-success'>Approve</a></td>";
                            // Reject button with href
                            echo "<td><a href='reject_institute.php?id=" . $row['login_id'] . "' class='btn btn-danger'>Reject</a></td>";
                            echo "</tr>";
                        }
                    } else {
