                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="glass-form">
                                <form action="user_signup_action.php" method="POST" enctype="multipart/form-data"> <!-- Added enctype for file upload -->
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="password" id="pass" class="form-control" name="password" minlength="4" required />
                                            </div>
                                            <div class="form-group">
