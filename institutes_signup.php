                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="glass-form">
                                <form action="institutes_signup_action.php" method="POST" enctype="multipart/form-data"> <!-- Added enctype for file upload -->
                                    <div class="row">
                                        <!-- Left Side of the Form -->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="first-name">Name</label>
                                                <input type="text" class="form-control" placeholder="Name" name="institute_name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="address">Address</label>
                                                <input type="text" class="form-control" placeholder="Address" name="institute_address" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="email">Email</label>
                                                <input type="email" class="form-control" placeholder="Email" name="institute_email" required>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" placeholder="Phone Number" name="institute_phone" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="country">Country</label>
                                                <select class="form-control" name="institute_country" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" placeholder="Write a brief description  here..." name="institute_description" required></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="photo">Documents</label>
                                                <input type="file" class="form-control" name="documents" accept="image/*" required> <!-- Photo upload field -->
                                            </div>
                                            <div class="form-group">
                                                <label for="photo">Profile Photo</label>
                                                <input type="file" class="form-control" name="institute_photo" accept="image/*" required> <!-- Photo upload field -->
                                            </div>
                                        </div>
                                    </div>
