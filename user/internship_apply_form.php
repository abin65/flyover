                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="glass-form">
                                <form action="internship_apply_form_action.php" method="POST" enctype="multipart/form-data"> <!-- Added enctype for file upload -->
                                    <div class="row">
                                        <!-- Left Side of the Form -->
                                        <input type="hidden" name="internship_id" value="<?php echo $internship_id; ?>"> <!-- Hidden input for course_id -->
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" name="internship_application" accept="image/*" required> <!-- Photo upload field -->
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn btn-primary px-4">Internship Apply</button>
                                    </div>
                                </form>
                            </div>
                        </div>
