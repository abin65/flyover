                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="nation" >
                                                    ...
                                                    <option value="USA" <?php echo ($user['nation'] == 'USA') ? 'selected' : ''; ?>>United States</option>
                                                    <option value="CAN" <?php echo ($user['nation'] == 'CAN') ? 'selected' : ''; ?>>Canada</option>
                                                    <option value="GBR" <?php echo ($user['nation'] == 'GBR') ? 'selected' : ''; ?>>United Kingdom</option>
                                                    <option value="AUS" <?php echo ($user['nation'] == 'AUS') ? 'selected' : ''; ?>>Australia</option>
                                                    <option value="IND" <?php echo ($user['nation'] == 'IND') ? 'selected' : ''; ?>>India</option>
                                                    <option value="DEU" <?php echo ($user['nation'] == 'DEU') ? 'selected' : ''; ?>>Germany</option>
                                                    <option value="FRA" <?php echo ($user['nation'] == 'FRA') ? 'selected' : ''; ?>>France</option>
                                                    <option value="ITA" <?php echo ($user['nation'] == 'ITA') ? 'selected' : ''; ?>>Italy</option>
                                                    <option value="ESP" <?php echo ($user['nation'] == 'ESP') ? 'selected' : ''; ?>>Spain</option>
                                                    <option value="MEX" <?php echo ($user['nation'] == 'MEX') ? 'selected' : ''; ?>>Mexico</option>
                                                    <option value="BRA" <?php echo ($user['nation'] == 'BRA') ? 'selected' : ''; ?>>Brazil</option>
                                                    <!-- Add more countries as needed -->
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="qualification">Qualification</label>
                                                <input type="text" class="form-control" name="qualification" value="<?php echo htmlspecialchars($user['qualification']); ?>" >
                                            </div>
                                            <div class="form-group">
                                                <label for="certificate">Certificate</label>
                                                <input type="file" class="form-control" name="certificate" accept="image/*"> <!-- Optional file upload field -->
                                            </div>
                                            <div class="form-group">
