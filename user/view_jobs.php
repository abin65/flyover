            ...
            <div class="row">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        // "Apply Now" button
                        if (!$is_expired) {
                            echo '<a href="job_apply_form.php?id=' . $job_id . '" class="btn btn-success">Apply Now</a>'; // Apply button for non-expired jobs
                        }
...
<style>
    .expired {
        background-color: #f8d7da; /* Light red background for expired jobs */
        border-color: #f5c6cb; /* Light red border */
    }

    .expired .text {
        color: #721c24; /* Dark red text for expired jobs */
    }
</style>
