                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="glass-form">
                                <form action="course_apply_form_action.php" method="POST" enctype="multipart/form-data"> <!-- Added enctype for file upload -->
                                    <div class="row">
                                        <!-- Left Side of the Form -->
                                        <input type="hidden" name="course_id" value="<?php echo $course_id; ?>"> <!-- Hidden input for course_id -->
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" name="adhar" accept="image/*" required> <!-- Photo upload field -->
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="pan_card">Pan_card</label>
                                                <input type="file" class="form-control" name="pan_card" accept="image/*" required> <!-- Photo upload field -->
                                            </div>
                                            <div class="form-group">
                                                <label for="passport">Passport</label>
                                                <input type="file" class="form-control" name="passport" accept="image/*" required> <!-- Photo upload field -->
                                            </div>
                                            <div class="form-group">
                                                <label for="application">Application</label>
                                                <input type="file" class="form-control" name="application" accept="image/*" required> <!-- Photo upload field -->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn btn-primary px-4">Course Apply</button>
                                    </div>
                                </form>
                            </div>
                        </div>
