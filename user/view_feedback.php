            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    ...
                    $query = "
                        ...
                        INNER JOIN feedabck f ON r.institute_reg_id = f.institute_id 
