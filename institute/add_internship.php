                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="glass-form">
                                <form action="add_internship_action.php" method="POST" enctype="multipart/form-data"> <!-- Added enctype for file upload -->
                                    <div class="row">
                                        <!-- Left Side of the Form -->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="intership-name">Internship Name</label>
                                                <input type="text" class="form-control" placeholder="Internship Name" name="intership_name" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="Stipend" name="stipend" required>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" placeholder="Expire Date" name="expire_date" required>
                                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn btn-primary px-4">Add Internship</button>
                                    </div>
                                </form>
                            </div>
                        </div>
