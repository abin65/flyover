            ...
            <table class="table table-bordered table-hover table-striped glass-table">
                ...
                <tbody>
                    ...
                    $query = "SELECT ia.*, i.internship_title 
                                ...
                                WHERE ia.institute_id = '$institute_id' and ia.apply_status IN ('applied', 'approved') ";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='intership_report_approve_action.php?id=" . $row['internship_apply_id'] . "' class='btn btn-success'>Approve</a></td>";
                            // Reject button with href
                            echo "<td><a href='internship_report_reject_action.php?id=" . $row['internship_apply_id'] . "' class='btn btn-danger'>Reject</a></td>";
                            echo "</tr>";
                            echo "</tr>";
                        }
                    } else {
