                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="glass-form">
                                <form action="add_course_action.php" method="POST" enctype="multipart/form-data"> <!-- Added enctype for file upload -->
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Course Duration" name="course_duration" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="Fees">Fees</label>
                                                <input type="number" class="form-control" placeholder="Fees" name="fees" required>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                           <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" placeholder="Write Eligibilitys  here..." name="eligibility" required></textarea>
                                            </div>
