            ...
            <table class="table table-bordered table-hover table-striped glass-table">
                ...
                <tbody>
                    ...
                    $query = "SELECT ca.*, c.course_name,c.course_profile, i.institute_name,i.login_id, i.institute_address, i.institute_country 
                              ...
                              WHERE ca.apply_status IN ('apply') and ca.institute_id='$userId' ";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='course_report_approve_action.php?id=" . $row['course_apply_id'] . "' class='btn btn-success'>Approve</a></td>";
                            // Reject button with href
                            echo "<td><a href='course_report_reject_action.php?id=" . $row['course_apply_id'] . "' class='btn btn-danger'>Reject</a></td>";
                            echo "</tr>";
                        }
                    } else {
